...
```
Context: I have a working calorie tracker app with hardcoded food data and a local database. Now I want to make it smarter using the Gemini API (model: gemini-2.5-flash-lite). The API key is already in my .env file as GEMINI_API_KEY.
